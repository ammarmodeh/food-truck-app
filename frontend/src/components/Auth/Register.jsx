    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
      ...
      >
        ...
        {recaptchaError && (
          <motion.div
            variants={itemVariants}
            className="mb-6 p-4 bg-orange-50 border border-orange-100 text-orange-700 rounded-xl"
          >
        ...
        <form onSubmit={showOtpField ? onSubmit : requestOtp} className="space-y-6">
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className="w-full p-4 rounded-xl bg-gray-50 text-gray-900 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-500 transition duration-300"
              required
            />
          </motion.div>
