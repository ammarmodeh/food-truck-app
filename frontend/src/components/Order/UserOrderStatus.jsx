      ...
      >
        <div className="section-container">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-300 mb-2">Please log in</h3>
          ...
          <div className="space-y-12 sm:mt-20">
            ...
            <motion.div variants={sectionVariants}>
              ...
              {activeOrders.length === 0 ? (
                <motion.div
                  className="text-center py-8 card-gradient-bg rounded-3xl shadow-lg backdrop-blur-sm border border-gray-700"
                  variants={itemVariants}
                >
                      ...
                      >
                        <div className="p-6">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="flex items-center space-x-2 px-3 py-1 rounded-full font-semibold text-sm bg-blue-900 text-blue-400">
                      ...
                      >
                        <div className="p-6">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="flex items-center space-x-2 px-3 py-1 rounded-full font-semibold text-sm bg-red-900 text-red-400">
